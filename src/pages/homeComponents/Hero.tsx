         ...
         <main className="px-[104px] py-[64px] flex items-center justify-between relative">
          ...
          <section className="flex flex-1 flex-col gap-[24px] text-white text-[16px] font-[500] py-[60px] z-40">
            ...
            <div className=" flex items-center gap-[12px]"> 
              ...
              <button className=" bg-[#121212] py-[8px] px-[32px] rounded-[8px] text-[16px] text-white  flex items-center gap-[10px]"><span>+</span> <span>Create</span></button>  
                </div>  
              </div>
              {/* count  */}
          ...
          {/* right sction  */}
          <section className="flex flex-1 items-center justify-center gap-[24px] text-white text-[16px] font-[500]  z-40">
